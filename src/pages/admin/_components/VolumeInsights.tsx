        ...
        <AreaChart data={data} margin={{ top: 10, right: 12, left: -12, bottom: 0 }}>
          <defs>
            ...
            <linearGradient id="successFill" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#0B57D0" stopOpacity={0.3} />
          ...
          <Area type="monotone" dataKey="volume" stroke="#4285F4" strokeWidth={2} fill="url(#volFill)" name="Total" />
          <Area type="monotone" dataKey="success" stroke="#0B57D0" strokeWidth={2} fill="url(#successFill)" name="Success" />
        </AreaChart>
      </ResponsiveContainer>
    </ChartCard>
  )
